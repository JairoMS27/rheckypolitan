...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Rheckypolitan — Archivo de crónicas desde Kentucky" },
      {
        property: "og:description",
        content:
          "Archivo digital de Rheckypolitan: crónicas, ensayos y postales editoriales desde Kentucky.",
      },
      { property: "og:url", content: "https://rheckypolitan.es/" },
      { property: "og:type", content: "website" },
    ],
    links: [{ rel: "canonical", href: "https://rheckypolitan.es/" }],
    scripts: [
      {
...
function Index() {
  ...
  const fetchSubscriberCount = useServerFn(getSubscriberCount);
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="border-b border-foreground">
        ...
        <nav className="border-t border-foreground/10">
          <ul className="mx-auto flex max-w-[1600px] items-center justify-center gap-6 px-6 py-3 md:gap-10">
            <li><Link to="/actualidad" className="font-mono text-[10px] uppercase tracking-widest text-muted-foreground hover:text-[#B22234]">Actualidad</Link></li>
            <li><Link to="/entretenimiento" className="font-mono text-[10px] uppercase tracking-widest text-muted-foreground hover:text-[#B22234]">Entretenimiento</Link></li>
      ...
      <main className="mx-auto max-w-[1600px] px-6 py-10 md:py-16">
        ...
        <section className="mb-16 grid grid-cols-1 gap-10 lg:mb-24 lg:grid-cols-12 lg:gap-12">
          <div className="lg:col-span-7 lg:border-r lg:border-foreground/10 lg:pr-12">
            ...
            <p className="mt-8 max-w-md text-base leading-relaxed text-foreground/80 md:text-lg">
              Crónicas, ensayos y postales desde Kentucky. Hojea cada número
              como si tuvieras la revista entre las manos: portada, lomo y
              páginas que se pasan al ritmo del bourbon.
            </p>
          </div>
          ...
          <aside className="flex flex-col gap-8 lg:col-span-5">
            {issues && issues[0] ? (
              <div className="border border-foreground/15 p-6">
                ...
                <div className="flex items-start gap-5">
                  <div aria-hidden className="select-none font-display text-[5.5rem] font-black leading-none text-foreground/10">
                  ...
                  <div className="pt-1">
                    ...
                    <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                      Última entrega del archivo: cultura contemporánea, diseño y
                      tipografía editorial en una sola pieza.
                    </p>
                    <Link
                      to="/revista/$number"
                      params={{ number: String(issues[0].number) }}
                ...
                <div className="mt-5 flex items-center gap-3 border-t border-foreground/10 pt-4 font-mono text-[10px] uppercase tracking-widest text-muted-foreground">
                  <span>{issues.length} {issues.length === 1 ? "número" : "números"} en archivo</span>
            ...
            <blockquote className="relative border-l-2 border-[#B22234] bg-muted p-6 pt-8">
              <span aria-hidden className="absolute left-4 top-0 font-display text-6xl leading-none text-[#B22234]">“</span>
              <p className="font-display text-lg italic leading-snug text-foreground md:text-xl">
                Nunca os fiéis de las personas que viven debajo de vosotros. Si os drenan la batería, la única solución es drenarles a ellos la switch
              </p>
        ...
        {/* Dateline editorial — contador de suscriptores en directo */}
        <section
        ...
        >
          {/* Izquierda: indicador en directo */}
          ...
          <div className="flex flex-col items-center gap-2 md:justify-self-center">
            ...
            >
              ...
              <span className="ml-2 self-center font-display text-[10px] uppercase tracking-[0.3em] text-muted-foreground">
                lectores<br />suscritos
              </span>
            </div>
          </div>

          {/* Derecha: rótulo de la sección siguiente */}
        ...
        <section className="mt-24">
          ...
          <ul className="grid grid-cols-1 gap-6 md:grid-cols-3 md:auto-rows-fr">
            {COLUMNISTAS.map((c) => (
              <li key={c.initials} className="group flex h-full flex-col border border-foreground/15 p-6 transition hover:border-foreground/40">
                    ...
                    {items.map((i) => (
                      <li key={i.id}>
                        ...
                        >
                          ...
                          <span className="normal-case tracking-normal text-foreground/70">{i.title}</span>
                        </Link>
                      </li>
                    ))}
                  </ul>
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
            <div className="lg:col-span-7">
              ...
              <p className="mt-4 max-w-md text-sm leading-relaxed text-background/70">
                Te avisamos cuando publicamos un nuevo número y, de paso, te
                mandamos una columna corta escrita a mano. Sin spam, sin trucos.
              </p>
            </div>
            <form onSubmit={handleSubscribe} className="flex flex-col justify-end gap-3 lg:col-span-5">
              <label htmlFor="newsletter-email" className="font-mono text-[10px] uppercase tracking-[0.3em] text-background/60">
                Tu correo
              </label>
