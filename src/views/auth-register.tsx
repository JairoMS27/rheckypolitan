  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="flex min-h-[calc(100vh-8px)] flex-col items-center justify-center px-6">
        <Link href="/" className="mb-12 font-display text-3xl font-semibold tracking-tight">
          Rheckypolitan
        </Link>
        ...
        <div className="w-full max-w-sm">
          {!sent ? (
            <>
              ...
              <h1 className="mt-2 font-display text-3xl leading-tight">Crear cuenta</h1>
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                Únete a la comunidad de Rheckypolitan. Comenta artículos y participa en la
                conversación.
              </p>
            ...
            <div className="text-center">
              ...
              <h1 className="mt-2 font-display text-3xl leading-tight">Revisa tu correo</h1>
              <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
                Hemos enviado un enlace a{" "}
                <span className="font-medium text-foreground">{email}</span>. Haz clic para
                verificar tu cuenta y empezar a comentar.
              </p>
              <button
