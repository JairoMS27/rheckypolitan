              ...
              <div className="border border-foreground/15 transition-colors focus-within:border-foreground/40">
                ...
                <div className="flex items-center justify-between border-t border-foreground/10 px-4 py-2">
                  ...
                  <button
                    ...
                    className="border border-foreground bg-foreground px-5 py-1.5 font-mono text-[10px] font-bold uppercase tracking-widest text-background transition hover:bg-[#B22234] hover:border-[#B22234] disabled:opacity-40"
                  >
            ...
            return (
              <li key={comment.id} className="py-5 first:pt-0">
                <div className="flex gap-3">
                  {/* Avatar */}
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center bg-foreground font-mono text-[9px] font-bold text-background">
                      ...
                      <div className="mt-2">
                        ...
                        <div className="mt-2 flex gap-2">
                          <button
                            ...
                            className="border border-foreground bg-foreground px-4 py-1 font-mono text-[10px] font-bold uppercase tracking-widest text-background transition hover:bg-[#B22234] hover:border-[#B22234] disabled:opacity-40"
                          >
                            Guardar
                          </button>
                          <button
